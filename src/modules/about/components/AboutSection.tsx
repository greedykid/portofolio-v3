    ...
    <section className="w-full">
      <div className="max-w-[1280px] mx-auto px-4 md:px-6">
        <div className="flex flex-col-reverse lg:flex-row gap-6">
          {/* About card */}
          <div className="w-full lg:w-[70%] bg-white dark:bg-[#141414] rounded-3xl p-6 md:p-10 lg:p-12 relative group border-2 border-neutral-300/80 dark:border-white/10 shadow-[6px_6px_0px_0px_rgba(99,102,241,0.25)] dark:shadow-[6px_6px_0px_0px_rgba(99,102,241,0.4)] rtl:shadow-[-6px_6px_0px_0px_rgba(99,102,241,0.4)] overflow-hidden">
            {/* gradient beam */}
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4 md:space-y-6">
                {PROFILE.aboutParagraphs.map((para, i) => (
                  <p key={i} className="text-neutral-700 dark:text-neutral-200 text-base md:text-lg leading-relaxed">
                    {para}
                  </p>
                ))}
              </div>
              <a
                href="/about"
                className="mt-6 md:mt-8 inline-flex items-center gap-2 text-primary dark:text-white hover:underline transition-colors group/link"
              >
          ...
          <div className="flex items-center justify-center w-full lg:w-[30%]" style={{ perspective: '1000px' }}>
            <div className="[transform-style:preserve-3d] w-full h-full">
              <div className="transition duration-200 ease-linear w-full h-full">
                <div className="flex h-full min-h-[200px] w-full items-center justify-center rounded-3xl border-2 border-neutral-900 dark:border-white/20 bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-neutral-900 dark:to-neutral-950 text-8xl font-brak font-bold text-neutral-900 dark:text-white shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] dark:shadow-[6px_6px_0px_0px_rgba(99,102,241,0.4)]">
