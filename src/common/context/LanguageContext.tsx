...
const DICTIONARY: Record<Locale, Dictionary> = {
  id: {
    ...
    hero_greeting: 'Halo',
    hero_im: 'Saya Rizki.',
    hero_headline_1: 'Saya merancang & mengembangkan ',
    hero_headline_badge: 'aplikasi web & sistem digital',
    ...
    projects_desc: 'Koleksi aplikasi e-commerce, website katalog digital aktif, dan proyek rekayasa sistem yang pernah saya kembangkan.',
    ...
    exp_title: 'Pengalaman Proyek & Karir',
    exp_desc: 'Implementasi proyek e-commerce, website katalog digital, dan riset pengembangan sistem.',
    exp_timeline_title: 'Linimasa Proyek & Karir',
    exp_years_badge: '2022 - 2026',
    exp_period_label: '@Universitas Gunadarma & Freelance',
    exp_present: 'Sekarang',

    edu_title: 'Pendidikan & Sertifikasi',
    edu_desc: 'Pondasi akademik formal S1 Sistem Informasi dan sertifikasi kompetensi dari Universitas Gunadarma.',
    ...
    contact_msg: 'Pesan / Kebutuhan Proyek',
    contact_msg_ph: 'Ceritakan detail kebutuhan sistem atau sekadar menyapa...',
    ...
    footer_link_tools: 'Tools & Keahlian',
  ...
  en: {
    ...
    hero_greeting: 'Hey',
    hero_im: "I'm Rizki.",
    hero_headline_1: 'I engineer & develop ',
    hero_headline_badge: 'web apps & digital systems',
    ...
    projects_desc: 'A collection of e-commerce platforms, live digital catalogs, and system development projects I have built.',
    ...
    exp_title: 'Project & Career Experience',
    exp_desc: 'My trajectory building e-commerce platforms, live digital catalogs, and systems research.',
    exp_timeline_title: 'Project & Career Timeline',
    exp_years_badge: '2022 - 2026',
    exp_period_label: '@Universitas Gunadarma & Freelance',
    exp_present: 'Present',

    edu_title: 'Education & Certificates',
    edu_desc: 'Information Systems Bachelor degree from Universitas Gunadarma and verified professional certifications.',
    ...
    contact_msg_ph: 'Tell me about your project goals, role opening, or just say hi...',
    ...
    footer_link_tools: 'Tools & Skills',
