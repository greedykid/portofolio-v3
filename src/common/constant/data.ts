export const SITE = {
  ...
  name: 'Rizki Arbiansyah Portfolio',
  author: 'Rizki Arbiansyah',
  title: 'Rizki Arbiansyah — Web Developer & IT Support',
  description:
    'Lulusan S1 Sistem Informasi Universitas Gunadarma dengan kompetensi di bidang IT Support dan keahlian pengembangan aplikasi web berbasis Laravel, MySQL, dan Tailwind CSS.',
