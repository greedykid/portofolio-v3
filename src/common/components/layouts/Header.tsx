  ...
  return (
    <header className="sticky top-3 md:top-4 z-[100] w-full transition-all duration-300 pointer-events-auto">
      <Container className="max-w-[1280px]">
        <div
          className={cn(
            'relative flex items-center justify-between rounded-3xl border-2 border-neutral-300/80 dark:border-white/10 bg-white/95 dark:bg-neutral-950/95 backdrop-blur-md px-3.5 md:px-6 transition-all duration-300 ease-out',
            scrolled
        ...
        >
          ...
          <div className="flex items-center gap-2 md:gap-2.5 ms-2">
